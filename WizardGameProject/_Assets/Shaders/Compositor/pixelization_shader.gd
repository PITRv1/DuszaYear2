...
func _render_callback(_callback_type: int, render_data: RenderData) -> void:
	...
	push_constants.append(down_scaling)
...
func initialize_computer_shader() -> void:
	...
	var glsl_file : RDShaderFile = load("res://assets/materials/shaders/compositor/pixelization_compute.glsl")
